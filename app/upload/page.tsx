        ...
        <main className="flex-1">
          <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="rounded-lg border border-zinc-200 bg-white p-8 text-center dark:border-zinc-800 dark:bg-black">
              ...
              <p className="mt-2 text-zinc-600 dark:text-zinc-400">
                Only admin creators can upload videos.
              </p>
            </div>
          </div>
        </main>
        ...
        <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-black">
            <h2 className="mb-4 text-xl font-semibold text-black dark:text-white">
              Video Details & Upload
            </h2>
            <VideoUploadForm onSuccess={(id) => setLastVideoId(id)} />
            {lastVideoId && (
              <div className="mt-4 text-sm text-zinc-600 dark:text-zinc-400">
                Latest upload:{' '}
                <a href={`/videos/${lastVideoId}`} className="font-medium text-black hover:underline dark:text-white">
                  View video →
                </a>
              </div>
            )}
